...
using MFramework.Domain.Objects;
...
namespace MFramework.Domain.DomainEntity
{
    ...
    /// </summary>
    [Serializable]
    public abstract class EntityWithTypedId<TId, TEntity> : ValidatableBaseObject<TEntity>, IEntityWithTypedId<TId>,IValidatableObject
        where TEntity : EntityWithTypedId<TId,TEntity>
    {
        /// <summary>
        ...
        #region Constructors
            protected EntityWithTypedId(IValidator<TEntity> validator):base(validator){}
        #endregion
        /// <summary>
        ...
        {
            var compareTo = obj as EntityWithTypedId<TId,TEntity>;
        ...
        {
            var context = new DataAnnotationValidationContext(validationContext);
            if (! context.IsValidationActive) return Validate().AsValidationResult();
        ...
        /// </summary>
        private bool HasSameNonDefaultIdAs(EntityWithTypedId<TId,TEntity> compareTo)
        {
