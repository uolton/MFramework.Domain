...
using MFramework.Common.CustomTypeProviders.Extensions;

namespace MFramework.Domain.Castle.Components.Validator
{
    /// <summary>
	...
	public class CachedMetadataCustomProviderValidationRegistry : IValidatorRegistry
	{
		...
		/// </summary>
		static CachedMetadataCustomProviderValidationRegistry ()
		{
		...
		/// </summary>
		public CachedMetadataCustomProviderValidationRegistry ()
		{
		}
        ...
        public CachedMetadataCustomProviderValidationRegistry(ResourceManager resourceManager)
		{
		...
		public IValidator[] GetValidators(IValidatorRunner validatorRunner, Type targetType, RunWhen runWhen)
		{
		    ...
		    _metaDataType =
		        ((MetadataTypeAttribute)
		            TypeDescriptor.GetAttributes(targetType).ToList().First(a => a is MetadataTypeAttribute))
		            .MetadataClassType;
